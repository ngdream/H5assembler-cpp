...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_command_call = 12,              /* command_call  */
  YYSYMBOL_tail = 13,                      /* tail  */
  YYSYMBOL_tails = 14,                     /* tails  */
  YYSYMBOL_content_part = 15,              /* content_part  */
  YYSYMBOL_content = 16                    /* content  */
};
...
{
  "\"end of file\"", "error", "\"invalid token\"", "STRING", "COMMAND",
  "LPAREN", "RPAREN", "LBRACE", "RBRACE", "TXT", "$accept", "program",
  "command_call", "tail", "tails", "content_part", "content", YY_NULLPTR
};
...
{
       7,   -16,    -4,   -16,   -16,   -16,     2,   -16,   -16,     7,
      11,   -16,   -16,     9,    15,    14,   -16,   -16,   -16,   -16,
     -16,   -16,     0,   -16,   -16
};
...
{
       0,    15,     0,    14,    13,    12,     0,    16,    18,     2,
       0,     1,    17,     0,     3,     0,     8,     7,     6,     5,
       9,    11,     0,     4,    10
};
...
{
      20,    10,    11,    16,     2,    17,    18,    20,    23,    19,
       1,     2,     3,     4,    13,    14,     5,    16,     2,    17,
      18,    24,    15,    19,     0,    12
};

static const yytype_int8 yycheck[] =
{
      15,     5,     0,     3,     4,     5,     6,    22,     8,     9,
       3,     4,     5,     6,     3,     6,     9,     3,     4,     5,
       6,    22,     7,     9,    -1,     9
};
...
{
       0,     3,     4,     5,     6,     9,    11,    12,    15,    16,
       5,     0,    15,     3,     6,     7,     3,     5,     6,     9,
      12,    13,    14,     8,    13
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* command_call: COMMAND LPAREN STRING RPAREN  */
#line 44 "h5parse.y"
                                               {
    string dir=basedir;
    if(dir!="")
...
#line 108 "h5parse.y"
    ...
    {
        cout<<"reapeat instruction :"<<(yyvsp[-4].str)<<" times"<<endl;
        string repeated;
        for(int i=0 ;i<atoi((yyvsp[-4].str));i++)
        {
            repeated+=(yyvsp[-1].str);
        }
        (yyval.str)=new char[repeated.size()];
        strcpy((yyval.str),repeated.c_str());
       
    }
    else if (string((yyvsp[-6].str))=="@layout")
    {
        layout_data[(yyvsp[-4].str)]=(yyvsp[-1].str);
    }
